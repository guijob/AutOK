...
<html lang="en">
  ...
  <body>
	...
	<form:form class="form-horizontal" style="margin: 0 auto; width:80%;" action="/autok/editarFuncionario" method="POST" modelAttribute="funcionarioEntidade">
	  <fieldset>
	    <div id="legend">
	      <legend>Preencha os campos abaixo para editar Funcionario</legend>
	    </div>
