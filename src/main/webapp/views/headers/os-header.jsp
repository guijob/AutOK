	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<c:choose>
					<c:when test="${usuarioLogado.tipo == 'cliente'}">
						<li><a
							href="${pageContext.request.contextPath}/listarVeiculos">Veículos</a></li>
					</c:when>
				</c:choose>
				<li><a
					href="${pageContext.request.contextPath}/listarAgendamentos">Agendamentos</a></li>
				<li class="active"><a
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a
					href="${pageContext.request.contextPath}/acessarConta"
					class="dropdown-toggle" data-toggle="dropdown" role="button"
					aria-haspopup="true" aria-expanded="false"><span
						class="glyphicon glyphicon-cog"></span></a>
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/configuracoesConta">Configurações
								da conta </a></li>
						<li><a href="#"></a></li>
